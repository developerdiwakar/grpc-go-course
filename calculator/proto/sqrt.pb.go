...
var file_calculator_proto_sqrt_proto_rawDesc = []byte{
	0x0a, 0x1b, 0x63, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x2f, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x2f, 0x73, 0x71, 0x72, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0a, 0x63,
	0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x22, 0x25, 0x0a, 0x0b, 0x53, 0x71, 0x72,
	...
	0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x42, 0x3d, 0x5a, 0x3b, 0x67, 0x69, 0x74, 0x68,
	0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x64, 0x65, 0x76, 0x65, 0x6c, 0x6f, 0x70, 0x65, 0x72,
	0x64, 0x69, 0x77, 0x61, 0x6b, 0x61, 0x72, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x2d, 0x67, 0x6f, 0x2d,
...
var (
	...
	file_calculator_proto_sqrt_proto_rawDescData = file_calculator_proto_sqrt_proto_rawDesc
)

func file_calculator_proto_sqrt_proto_rawDescGZIP() []byte {
	file_calculator_proto_sqrt_proto_rawDescOnce.Do(func() {
		file_calculator_proto_sqrt_proto_rawDescData = protoimpl.X.CompressGZIP(file_calculator_proto_sqrt_proto_rawDescData)
	})
...
var file_calculator_proto_sqrt_proto_goTypes = []interface{}{
...
func file_calculator_proto_sqrt_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_calculator_proto_sqrt_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_calculator_proto_sqrt_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_calculator_proto_sqrt_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_calculator_proto_sqrt_proto_rawDesc = nil
