...
var file_calculator_proto_sum_proto_rawDesc = []byte{
	0x0a, 0x1a, 0x63, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x2f, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x2f, 0x73, 0x75, 0x6d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0a, 0x63, 0x61,
	...
	0x52, 0x0c, 0x73, 0x65, 0x63, 0x6f, 0x6e, 0x64, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x22, 0x25,
...
var (
	...
	file_calculator_proto_sum_proto_rawDescData = file_calculator_proto_sum_proto_rawDesc
)

func file_calculator_proto_sum_proto_rawDescGZIP() []byte {
	file_calculator_proto_sum_proto_rawDescOnce.Do(func() {
		file_calculator_proto_sum_proto_rawDescData = protoimpl.X.CompressGZIP(file_calculator_proto_sum_proto_rawDescData)
	})
...
func file_calculator_proto_sum_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_calculator_proto_sum_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_calculator_proto_sum_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_calculator_proto_sum_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_calculator_proto_sum_proto_rawDesc = nil
